...
import { SafeHtmlPipe } from '@ntx-core/pipes/safe-html.pipe';
...
export class SvgIconsComponent implements OnChanges {
  ...
  icons: { [key: string]: string } = {
    ...
    `,
    enterFullscreen: `
      <svg xmlns="http://www.w3.org/2000/svg" width="size" height="size" fill="currentColor" class="fill-white" viewBox="0 0 16 16">
    ...
    `,
    upload: `
      <svg xmlns="http://www.w3.org/2000/svg" width="size" height="size" fill="currentColor" class="" viewBox="0 0 16 16">
        <path d="M.5 9.9a.5.5 0 0 1 .5.5v2.5a1 1 0 0 0 1 1h12a1 1 0 0 0 1-1v-2.5a.5.5 0 0 1 1 0v2.5a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2v-2.5a.5.5 0 0 1 .5-.5" />
        <path d="M7.646 1.146a.5.5 0 0 1 .708 0l3 3a.5.5 0 0 1-.708.708L8.5 2.707V11.5a.5.5 0 0 1-1 0V2.707L5.354 4.854a.5.5 0 1 1-.708-.708z" />
      </svg>
    `,
    search: `
      <svg xmlns="http://www.w3.org/2000/svg" width="size" height="size" fill="currentColor" viewBox="0 0 50 50">
    ...
    `,
    plus_square: `
      <svg xmlns="http://www.w3.org/2000/svg" width="size" height="size" fill="currentColor" class="bi bi-plus-square" viewBox="0 0 16 16">
        <path d="M14 1a1 1 0 0 1 1 1v12a1 1 0 0 1-1 1H2a1 1 0 0 1-1-1V2a1 1 0 0 1 1-1zM2 0a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V2a2 2 0 0 0-2-2z"/>
        <path d="M8 4a.5.5 0 0 1 .5.5v3h3a.5.5 0 0 1 0 1h-3v3a.5.5 0 0 1-1 0v-3h-3a.5.5 0 0 1 0-1h3v-3A.5.5 0 0 1 8 4"/>
      </svg>
    `,
    crop: `
      <svg xmlns="http://www.w3.org/2000/svg" width="size" height="size" fill="currentColor" class="bi bi-crop" viewBox="0 0 16 16">
    ...
    `,
    three_dots_vertical: `
      <svg xmlns="http://www.w3.org/2000/svg" width="size" height="size" fill="currentColor" class="bi bi-three-dots-vertical" viewBox="0 0 16 16">
        <path d="M9.5 13a1.5 1.5 0 1 1-3 0 1.5 1.5 0 0 1 3 0m0-5a1.5 1.5 0 1 1-3 0 1.5 1.5 0 0 1 3 0m0-5a1.5 1.5 0 1 1-3 0 1.5 1.5 0 0 1 3 0"/>
      </svg>
    `,
    file_image: `
    <svg xmlns="http://www.w3.org/2000/svg" width="size" height="size" fill="currentColor" class="bi bi-file-image" viewBox="0 0 16 16">
      <path d="M8.002 5.5a1.5 1.5 0 1 1-3 0 1.5 1.5 0 0 1 3 0"/>
      <path d="M12 0H4a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h8a2 2 0 0 0 2-2V2a2 2 0 0 0-2-2M3 2a1 1 0 0 1 1-1h8a1 1 0 0 1 1 1v8l-2.083-2.083a.5.5 0 0 0-.76.063L8 11 5.835 9.7a.5.5 0 0 0-.611.076L3 12z"/>
    </svg>
    `,
    clock: `
    <svg xmlns="http://www.w3.org/2000/svg" width="size" height="size" fill="currentColor" class="bi bi-clock" viewBox="0 0 16 16">
    ...
    plus: `
    <svg xmlns="http://www.w3.org/2000/svg" width="size" height="size" fill="currentColor" class="bi bi-plus-lg" viewBox="0 0 16 16">
      <path fill-rule="evenodd" d="M8 2a.5.5 0 0 1 .5.5v5h5a.5.5 0 0 1 0 1h-5v5a.5.5 0 0 1-1 0v-5h-5a.5.5 0 0 1 0-1h5v-5A.5.5 0 0 1 8 2"/>
    </svg>`,
    repeat: `
    <svg xmlns="http://www.w3.org/2000/svg" width="size" height="size" fill="currentColor" class="bi bi-arrow-repeat" viewBox="0 0 16 16">
      <path d="M11.534 7h3.932a.25.25 0 0 1 .192.41l-1.966 2.36a.25.25 0 0 1-.384 0l-1.966-2.36a.25.25 0 0 1 .192-.41m-11 2h3.932a.25.25 0 0 0 .192-.41L2.692 6.23a.25.25 0 0 0-.384 0L.342 8.59A.25.25 0 0 0 .534 9"/>
      <path fill-rule="evenodd" d="M8 3c-1.552 0-2.94.707-3.857 1.818a.5.5 0 1 1-.771-.636A6.002 6.002 0 0 1 13.917 7H12.9A5 5 0 0 0 8 3M3.1 9a5.002 5.002 0 0 0 8.757 2.182.5.5 0 1 1 .771.636A6.002 6.002 0 0 1 2.083 9z"/>
    </svg>`,
    bookmark_plus: `
    <svg xmlns="http://www.w3.org/2000/svg" width="size" height="size" fill="currentColor" class="bi bi-bookmark-plus" viewBox="0 0 16 16">
      <path d="M2 2a2 2 0 0 1 2-2h8a2 2 0 0 1 2 2v13.5a.5.5 0 0 1-.777.416L8 13.101l-5.223 2.815A.5.5 0 0 1 2 15.5zm2-1a1 1 0 0 0-1 1v12.566l4.723-2.482a.5.5 0 0 1 .554 0L13 14.566V2a1 1 0 0 0-1-1z"/>
      <path d="M8 4a.5.5 0 0 1 .5.5V6H10a.5.5 0 0 1 0 1H8.5v1.5a.5.5 0 0 1-1 0V7H6a.5.5 0 0 1 0-1h1.5V4.5A.5.5 0 0 1 8 4"/>
    </svg>`,
    bookmark_x: `
    <svg xmlns="http://www.w3.org/2000/svg" width="size" height="size" fill="currentColor" class="bi bi-bookmark-x" viewBox="0 0 16 16">
    ...
    card_image: `
    <svg xmlns="http://www.w3.org/2000/svg" width="size" height="size" fill="currentColor" class="bi bi-card-image" viewBox="0 0 16 16">
      <path d="M6.002 5.5a1.5 1.5 0 1 1-3 0 1.5 1.5 0 0 1 3 0"/>
      <path d="M1.5 2A1.5 1.5 0 0 0 0 3.5v9A1.5 1.5 0 0 0 1.5 14h13a1.5 1.5 0 0 0 1.5-1.5v-9A1.5 1.5 0 0 0 14.5 2zm13 1a.5.5 0 0 1 .5.5v6l-3.775-1.947a.5.5 0 0 0-.577.093l-3.71 3.71-2.66-1.772a.5.5 0 0 0-.63.062L1.002 12v.54L1 12.5v-9a.5.5 0 0 1 .5-.5z"/>
    </svg>`,
    trash: `<svg xmlns="http://www.w3.org/2000/svg" width="size" height="size" fill="currentColor" class="bi bi-trash" viewBox="0 0 16 16">
