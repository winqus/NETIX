...
import { FileUploadComponent } from '@ntx-pages/create-title/import-title/components/file-upload/file-upload.component';
import { ImageCropperComponent } from '@ntx-pages/create-title/import-title/components/image-cropper/image-cropper.component';
