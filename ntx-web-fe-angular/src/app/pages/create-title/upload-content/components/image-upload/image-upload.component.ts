...
import { FileUploadComponent } from '@ntx-pages/create-title/upload-content/components/file-upload/file-upload.component';
import { ImageCropperComponent } from '@ntx-pages/create-title/upload-content/components/image-cropper/image-cropper.component';
