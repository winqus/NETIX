...
describe('TMDBSearchTitlePlugin expected titles', () => {
  ...
  const TEST_TITLE_QUERIES = [
    ...
    { query: 'toy story', expected: 'Toy Story', expectedPositionRange: [0, 1] },
    ...
    { query: 'frozen', expected: 'Frozen', expectedPositionRange: [0, 1] },
    { query: 'frozen 2', expected: 'Frozen II', expectedPositionRange: [0, 1] },
    ...
    { query: 'lion king', expected: 'The Lion King', expectedPositionRange: [0, 1] },
    ...
    { query: 'demon slayer', expected: 'Demon Slayer: Kimetsu no Yaiba', expectedPositionRange: [0, 3] },
    ...
    { query: 'incredibles', expected: 'The Incredibles', expectedPositionRange: [0, 0] },
    ...
    { query: 'indiana jones raiders', expected: 'Raiders of the Lost Ark', expectedPositionRange: [0, 0] },
